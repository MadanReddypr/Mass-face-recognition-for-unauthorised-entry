...
#                 image_path = os.path.join(unknown_faces_dir, f"unknown_{len(captured_unknown_face_encodings)}.jpg")
...
# below code is working good for capturing one unknown image 
...
## below code for displaying unknown image 
...
#                 # Display the unknown face in the UI
...
# # Start updating the image in the UI
# update_image()
